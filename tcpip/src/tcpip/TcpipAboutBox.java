...
public class TcpipAboutBox extends javax.swing.JDialog {
    ...
    public TcpipAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(tcpip.TcpipApp.class).getContext().getResourceMap(TcpipAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(tcpip.TcpipApp.class).getContext().getActionMap(TcpipAboutBox.class, this);
